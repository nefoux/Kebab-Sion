    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <section id="accueil" className="hero">
        <div className="hero-content">
          <h1>
            Votre kebab préféré à Sion 🇨🇭
          </h1>
          <p>
            🥙 Kebab Sion – Goûtez nos spécialités maison, fraîches et préparées sur place
          </p>
      ...
      <section id="gallery" className="section bg-light">
        <div className="container-max">
          ...
          <div className="gallery-grid">
            {[
              {
                src: "https://images.unsplash.com/photo-1633321702518-7feccafb94d5?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2MzR8MHwxfHNlYXJjaHwyfHxrZWJhYnxlbnwwfHx8fDE3NTk5MjczNTB8MA&ixlib=rb-4.1.0&q=85",
                alt: "Kebab sandwich délicieux"
              },
              {
                src: "https://images.unsplash.com/photo-1530469912745-a215c6b256ea?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2MzR8MHwxfHNlYXJjaHwzfHxrZWJhYnxlbnwwfHx8fDE3NTk5MjczNTB8MA&ixlib=rb-4.1.0&q=85",
                alt: "Broche à kebab traditionnelle"
              },
              {
                src: "https://images.unsplash.com/photo-1529006557810-274b9b2fc783?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2MzR8MHwxfHNlYXJjaHw0fHxrZWJhYnxlbnwwfHx8fDE3NTk5MjczNTB8MA&ixlib=rb-4.1.0&q=85",
              ...
              {
                src: "https://images.unsplash.com/photo-1514933651103-005eec06c04b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njd8MHwxfHNlYXJjaHw0fHxyZXN0YXVyYW50fGVufDB8fHx8MTc1OTg2MzMxMnww&ixlib=rb-4.1.0&q=85",
                alt: "Ambiance du restaurant"
              },
              {
                src: "https://images.unsplash.com/photo-1556745750-68295fefafc5?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njd8MXwxfHNlYXJjaHwxfHxyZXN0YXVyYW50fGVufDB8fHx8MTc1OTg2MzMxMnww&ixlib=rb-4.1.0&q=85",
                alt: "Comptoir de service"
              },
              {
                src: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njd8MHwxfHNlYXJjaHwyfHxyZXN0YXVyYW50fGVufDB8fHx8MTc1OTg2MzMxMnww&ixlib=rb-4.1.0&q=85",
              ...
              {
                src: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2MzR8MHwxfHNlYXJjaHwxfHxrZWJhYnxlbnwwfHx8fDE3NTk5MjczNTB8MA&ixlib=rb-4.1.0&q=85",
                alt: "Plat de viandes grillées"
              }
            ].map((image, index) => (
            ...
            {[
              {
                name: "Marie Dupont",
                rating: 5,
                comment: "Meilleur kebab du Valais ! Service rapide et délicieux. Je recommande vivement !",
                date: "Il y a 2 jours"
              },
              {
                name: "Jean-Pierre Morand",
                rating: 5,
                comment: "Excellent accueil, produits frais et savoureux. Le kebab mixte est un régal !",
                date: "Il y a 1 semaine"
              },
              {
                name: "Sarah Klein",
                rating: 5,
                comment: "Super qualité, portions généreuses et prix corrects. Mon kebab préféré à Sion !",
      ...
      <section id="contact" className="section bg-light">
        <div className="container-max">
          ...
          <div className="contact-grid">
            ...
            <div>
              <div className="card" style={{ overflow: 'hidden', height: '400px', padding: 0 }}>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2751.234567890123!2d7.358621!3d46.229871!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDbCsDEzJzQ3LjUiTiA3wrAyMScyOS4yIkU!5e0!3m2!1sfr!2sch!4v1234567890123"
                  width="100%"
                  height="100%"
                  allowFullScreen
                  loading="lazy"
